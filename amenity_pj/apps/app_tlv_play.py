...
def get_sample_data(key):
    sample_data = {
        PhKeys.SAMPLE_1: {
            ...
            PhKeys.RAW_DATA: '86020102',
        },
        PhKeys.SAMPLE_2: {
            PhKeys.REMARKS_LIST: 'Parallel Simple TLVs',
            PhKeys.RAW_DATA: '81020105820106830209AB',
        },
        PhKeys.SAMPLE_3: {
            PhKeys.REMARKS_LIST: 'Multi Byte Tag; EID',
            PhKeys.RAW_DATA: 'BF3E125A1089049032123451234512345678901235',
        },
        PhKeys.SAMPLE_4: {
            PhKeys.REMARKS_LIST: 'Nested BER TLV; without One Liner',
            PhKeys.RAW_DATA: '064B21220D2048656C6C6F2C204275792031204742204461746120666F7220302E3520555344210F0D0D41726520596F7520537572653F151431107777772E66616365626F6F6B2E636F6D0500',
            'one_liner': False,
        },
        'sample_4_1': {
        ...
        PhKeys.SAMPLE_5: {
            ...
            PhKeys.RAW_DATA: '',
            'value_in_ascii': True,
            'length_in_decimal': True,
            'one_liner': True,
        },
...
def handle_requests():
    ...
    if request.method == PhKeys.POST:
        PhUtil.print_separator(main_text=f'{Const.TEMPLATE_TLV_PLAY} Post Request Started')
        ...
        PhUtil.print_separator(main_text=f'{Const.TEMPLATE_TLV_PLAY} Post Request Completed')
        return render_template(Const.TEMPLATE_TLV_PLAY, **default_data)
    return render_template(Const.TEMPLATE_TLV_PLAY, **default_data)
